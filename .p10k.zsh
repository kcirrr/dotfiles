# Generated by Powerlevel10k configuration wizard on 2020-08-03 at 17:19 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|tridentctl|helm|kubens|kubectx|oc|istioctl|kogito|'
